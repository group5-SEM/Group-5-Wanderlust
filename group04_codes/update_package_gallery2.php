...
$sql = "SELECT package.Image2, travelagent.Email from package, travelagent where package.Id='".$id."' AND travelagent.Email='".$email."'";
	...
	<div class="col-md-10 offset-md-1" id="update-window">
		...
		<div class="card card-outline-secondary">
			...
			<div class="card-header">
				<h3 class="mb-0">Update Package Gallery - Image2</h3>
			</div>
			
			
			<div class="card-body">
			
				<form method="post" action="update-package-gallery-process2.php" enctype='multipart/form-data' name="uform" id="update-form" class="form" role="form" >
					<fieldset>
						<div class="form-row">
							<div class="col">
								<div class="form-group">
									<label for="name">Image2:</label>
									<input type="file" name="image2" class="form-control" id="packageName" required />
							...
							<button type="submit" name="update" class="btn btn-secondary btn-lg float-right">Update Image2</button>
						</div>
					</fieldset>
				</form>
